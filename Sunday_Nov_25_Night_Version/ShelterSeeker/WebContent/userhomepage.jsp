...
<body>
	...
	<div id="searchForm">
		...
		<form action="javascript:onSearch();">
	        ...
	        <div class="form-group row">
	        	<label class="col-sm-4 col-form-label" for="criteriaZipCode">Search by Zip Code<span class="glyphicon glyphicon-map-marker"></span></label>
	        	<div class="col-sm-8">
	        		<input class="form-control" type="text" id="criteriaZipCode" value=<%=zipCode %> />
	        	</div>
	        </div>
		...
		<table id="searchResultsTable">
			<thead>
				<tr>
					<th>Shelter Name</th>
					<th>Shelter Info</th>
					<th>Distance From Shelter (miles)</th>
				</tr>
			</thead>
			<tbody>
	...
	function onSearch() {
		...
		if (document.getElementById("criteriaZipCode").value == "")
			parameters += "&zipCode=" + <%=zipCode%>; // !!!!! Hard coded, use session!
