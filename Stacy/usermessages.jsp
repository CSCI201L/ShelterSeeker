...
<head>
	<%
		...
		String navThree = "<li><a href=\"usersettings.jsp\">Profile</a></li>";
		String username = "";
		try {
			...
			if (isShelter.equals("1")) {
				navOne = "<li><a href=\"orgstats.jsp\">Shelter Statistics</a></li>";
				navThree = "<li><a href=\"orgsettings.jsp\">Profile</a></li>";
			}
		} catch (Exception e) {
